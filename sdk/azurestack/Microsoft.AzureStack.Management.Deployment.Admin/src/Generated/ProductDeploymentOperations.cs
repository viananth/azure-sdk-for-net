...
namespace Microsoft.AzureStack.Management.Deployment.Admin
{
    ...
    /// </summary>
    internal partial class ProductDeploymentOperations : IServiceOperations<DeploymentAdminClient>, IProductDeploymentOperations
    {
        /// <summary>
        /// Initializes a new instance of the ProductDeploymentOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ProductDeploymentOperations(DeploymentAdminClient client)
        {
            if (client == null)
            {
