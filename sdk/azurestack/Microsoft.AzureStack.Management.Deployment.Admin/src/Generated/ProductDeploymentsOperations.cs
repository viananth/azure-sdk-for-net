...
namespace Microsoft.AzureStack.Management.Deployment.Admin
{
    ...
    /// <summary>
    /// ProductDeploymentsOperations operations.
    /// </summary>
    internal partial class ProductDeploymentsOperations : IServiceOperations<DeploymentAdminClient>, IProductDeploymentsOperations
    {
        /// <summary>
        /// Initializes a new instance of the ProductDeploymentsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ProductDeploymentsOperations(DeploymentAdminClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse> UnlockWithHttpMessagesAsync(string productId, string duration = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            UnlockActionParameters unlockActionParameter = new UnlockActionParameters();
            if (duration != null)
            {
                unlockActionParameter.Duration = duration;
            }
            // Tracing
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "Unlock", tracingParameters);
            }
            // Construct URL
            ...
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(unlockActionParameter, Client.SerializationSettings);
        ...
        public async Task<AzureOperationResponse> BeginBootStrapWithHttpMessagesAsync(string productId, string version = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            BootStrapActionParameters bootstrapActionParameter = new BootStrapActionParameters();
            if (version != null)
            {
                bootstrapActionParameter.Version = version;
            }
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "BeginBootStrap", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            ...
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(bootstrapActionParameter, Client.SerializationSettings);
                _httpRequest.Content = new StringContent(_requestContent, System.Text.Encoding.UTF8);
                _httpRequest.Content.Headers.ContentType =System.Net.Http.Headers.MediaTypeHeaderValue.Parse("application/json; charset=utf-8");
            }
            // Set Credentials
        ...
        public async Task<AzureOperationResponse> BeginDeployWithHttpMessagesAsync(string productId, DeployActionParameters deployActionParameter, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "BeginDeploy", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            ...
            if(deployActionParameter != null)
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(deployActionParameter, Client.SerializationSettings);
                _httpRequest.Content = new StringContent(_requestContent, System.Text.Encoding.UTF8);
                _httpRequest.Content.Headers.ContentType =System.Net.Http.Headers.MediaTypeHeaderValue.Parse("application/json; charset=utf-8");
            }
            // Set Credentials
