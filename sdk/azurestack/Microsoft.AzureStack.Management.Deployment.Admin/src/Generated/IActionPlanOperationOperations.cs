...
namespace Microsoft.AzureStack.Management.Deployment.Admin
{
    ...
    /// </summary>
    public partial interface IActionPlanOperationOperations
    {
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<IPage<ActionPlanOperationResourceEntity>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
