...
namespace Microsoft.AzureStack.Management.Deployment.Admin
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<DeploymentAdminClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(DeploymentAdminClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Deployment.Admin/operations").ToString();
