...
namespace Microsoft.AzureStack.Management.Deployment.Admin
{
    ...
    /// <summary>
    /// ActionPlanOperationOperations operations.
    /// </summary>
    internal partial class ActionPlanOperationOperations : IServiceOperations<DeploymentAdminClient>, IActionPlanOperationOperations
    {
        /// <summary>
        /// Initializes a new instance of the ActionPlanOperationOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ActionPlanOperationOperations(DeploymentAdminClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<ActionPlanOperationResourceEntity>>> ListWithHttpMessagesAsync(string planId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<ActionPlanOperationResourceEntity>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<ActionPlanOperationResourceEntity>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        public async Task<AzureOperationResponse<ActionPlanOperationResourceEntity>> GetWithHttpMessagesAsync(string planId, string operationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<ActionPlanOperationResourceEntity>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ActionPlanOperationResourceEntity>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<ActionPlanOperationResourceEntity>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
