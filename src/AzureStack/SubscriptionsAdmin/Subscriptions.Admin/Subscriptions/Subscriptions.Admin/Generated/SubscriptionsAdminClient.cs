...
namespace Microsoft.AzureStack.Management.Subscriptions.Admin
{
    ...
    public partial class SubscriptionsAdminClient : ServiceClient<SubscriptionsAdminClient>, ISubscriptionsAdminClient, IAzureClient
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<OperationList>> ListOperationsWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (ApiVersion == null)
            {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Subscriptions.Admin/operations").ToString();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> RestoreDataWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.SubscriptionId");
