...
namespace Microsoft.AzureStack.Management.Subscriptions
{
    ...
    public static partial class DelegatedProviderOffersOperationsExtensions
    {
            ...
            /// The NextLink from the previous successful call to List operation.
            /// </param>
            public static Offer GetNext(this IDelegatedProviderOffersOperations operations, string nextPageLink)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Offer> GetNextAsync(this IDelegatedProviderOffersOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
