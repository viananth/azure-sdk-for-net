...
namespace Microsoft.AzureStack.Management.Subscriptions.Admin
{
    ...
    internal partial class OfferDelegationsOperations : IServiceOperations<SubscriptionsAdminClient>, IOfferDelegationsOperations
    {
        ...
        public async Task<AzureOperationResponse<IPage<DelegatedOffer>>> ListWithHttpMessagesAsync(string resourceGroup, string offer, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourcegroups/{resourceGroup}/providers/Microsoft.Subscriptions.Admin/offers/{offer}/offerDelegations").ToString();
