...
namespace Microsoft.AzureStack.Management.Subscriptions.Admin
{
    ...
    /// </summary>
    public partial interface IDelegatedProvidersOperations
    {
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<Subscription>> GetWithHttpMessagesAsync(string delegatedProvider, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
