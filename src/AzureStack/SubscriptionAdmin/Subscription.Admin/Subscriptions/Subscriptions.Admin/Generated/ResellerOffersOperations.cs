...
namespace Microsoft.AzureStack.Management.Subscriptions.Admin
{
    ...
    internal partial class ResellerOffersOperations : IServiceOperations<SubscriptionsAdminClient>, IResellerOffersOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<DelegatedProviderOffer>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
