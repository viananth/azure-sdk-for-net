...
namespace Microsoft.AzureStack.Management.AzureBridge.Admin.Models
{
    ...
    public partial class Activation
    {
        ...
        public Activation(string displayName = default(string), string azureRegistrationResourceIdentifier = default(string), string provisioningState = default(string), System.DateTime? expiration = default(System.DateTime?), bool? marketplaceSyndicationEnabled = default(bool?), bool? usageReportingEnabled = default(bool?))
        {
