...
namespace Microsoft.AzureStack.Management.AzureBridge.Admin
{
    ...
    internal partial class DownloadedProductsOperations : IServiceOperations<AzureBridgeAdminClient>, IDownloadedProductsOperations
    {
        ...
        public async Task<AzureOperationResponse<IPage<DownloadedProductResource>>> ListWithHttpMessagesAsync(string resourceGroup, string activationName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourcegroups/{resourceGroup}/providers/Microsoft.AzureBridge.Admin/activations/{activationName}/downloadedProducts").ToString();
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<DownloadedProductResource>> DeleteWithHttpMessagesAsync(string resourceGroup, string activationName, string productName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send request
            AzureOperationResponse<DownloadedProductResource> _response = await BeginDeleteWithHttpMessagesAsync(resourceGroup, activationName, productName, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<DownloadedProductResource>> BeginDeleteWithHttpMessagesAsync(string resourceGroup, string activationName, string productName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
