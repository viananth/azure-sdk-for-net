...
namespace Microsoft.AzureStack.Management.AzureBridge.Admin.Models
{
    ...
    public partial class ActivationResource : Resource
    {
        ...
        public ActivationResource(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string displayName = default(string), string azureRegistrationResourceIdentifier = default(string), string provisioningState = default(string), System.DateTime? expiration = default(System.DateTime?), bool? marketplaceSyndicationEnabled = default(bool?), bool? usageReportingEnabled = default(bool?))
