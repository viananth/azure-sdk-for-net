...
namespace Microsoft.AzureStack.Management.Network.Admin.Models
{
    ...
    /// </summary>
    public partial class ResourceTenant : Resource
    {
        /// <summary>
        ...
        public ResourceTenant(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string provisioningState = default(string), string subscriptionId = default(string), string tenantResourceUri = default(string))
