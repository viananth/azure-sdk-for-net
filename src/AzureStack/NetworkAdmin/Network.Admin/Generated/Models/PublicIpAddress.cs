...
namespace Microsoft.AzureStack.Management.Network.Admin.Models
{
    ...
    public partial class PublicIpAddress : Resource
    {
        ...
        public PublicIpAddress(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string etag = default(string), ProvisioningState? provisioningState = default(ProvisioningState?), string subscriptionId = default(string), string tenantResourceUri = default(string), string ipAddress = default(string), string ipPool = default(string), string allocationMethod = default(string))
