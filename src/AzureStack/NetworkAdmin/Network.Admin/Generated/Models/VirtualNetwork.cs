...
namespace Microsoft.AzureStack.Management.Network.Admin.Models
{
    ...
    public partial class VirtualNetwork : Resource
    {
        ...
        /// state.</param>
        public VirtualNetwork(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string etag = default(string), ProvisioningState? provisioningState = default(ProvisioningState?), string subscriptionId = default(string), string tenantResourceUri = default(string), VirtualNetworkConfigurationState configurationState = default(VirtualNetworkConfigurationState))
