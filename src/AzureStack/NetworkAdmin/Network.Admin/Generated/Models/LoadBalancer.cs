...
namespace Microsoft.AzureStack.Management.Network.Admin.Models
{
    ...
    public partial class LoadBalancer : Resource
    {
        ...
        /// addresses.</param>
        public LoadBalancer(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string etag = default(string), ProvisioningState? provisioningState = default(ProvisioningState?), string subscriptionId = default(string), string tenantResourceUri = default(string), IList<string> publicIpAddresses = default(IList<string>))
