...
namespace Microsoft.AzureStack.Management.Network.Admin
{
    ...
    public static partial class QuotasOperationsExtensions
    {
            ...
            /// Name of the resource.
            /// </param>
            public static void BeginDelete(this IQuotasOperations operations, string location, string quotaName)
            {
                operations.BeginDeleteAsync(location, quotaName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task BeginDeleteAsync(this IQuotasOperations operations, string location, string quotaName, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.BeginDeleteWithHttpMessagesAsync(location, quotaName, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
