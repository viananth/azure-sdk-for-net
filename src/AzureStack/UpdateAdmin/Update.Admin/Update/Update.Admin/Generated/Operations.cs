...
namespace Microsoft.AzureStack.Management.Update.Admin
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<UpdateAdminClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(UpdateAdminClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Update.Admin/operations").ToString();
