...
namespace Microsoft.AzureStack.Management.Update.Admin
{
    ...
    /// </summary>
    internal partial class UpdateRunsOperations : IServiceOperations<UpdateAdminClient>, IUpdateRunsOperations
    {
        /// <summary>
        /// Initializes a new instance of the UpdateRunsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal UpdateRunsOperations(UpdateAdminClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<UpdateRun>>> ListWithHttpMessagesAsync(string resourceGroup, string updateLocation, string update, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<UpdateRun>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<UpdateRun>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        public async Task<AzureOperationResponse> BeginRerunWithHttpMessagesAsync(string resourceGroup, string updateLocation, string update, string runId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("runId", runId);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "BeginRerun", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<UpdateRun>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
