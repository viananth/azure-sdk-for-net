...
namespace Microsoft.AzureStack.Management.InfrastructureInsights.Admin
{
    ...
    /// </summary>
    internal partial class ServiceHealthsOperations : IServiceOperations<InfrastructureInsightsAdminClient>, IServiceHealthsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ServiceHealthsOperations(InfrastructureInsightsAdminClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<ServiceHealth>>> ListWithHttpMessagesAsync(string resourceGroupName, string location, ODataQuery<ServiceHealth> odataQuery = default(ODataQuery<ServiceHealth>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<ServiceHealth>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<ServiceHealth>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        public async Task<AzureOperationResponse<ServiceHealth>> GetWithHttpMessagesAsync(string resourceGroupName, string location, string serviceHealth, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "serviceHealth");
            }
            if (Client.ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ApiVersion");
            ...
            // Create Result
            var _result = new AzureOperationResponse<ServiceHealth>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ServiceHealth>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<ServiceHealth>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
